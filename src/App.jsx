...
function exportAdminReportToPdf() {
  ...
  style.textContent = `
    @media print {
      ...
      .print-footer { display: block !important; visibility: visible !important; position: fixed; bottom: 0.5cm; left: 1.5cm; right: 1.5cm; text-align: center; font-size: 9pt; color: #666; border-top: 1px solid #ddd; padding-top: 4px; }
